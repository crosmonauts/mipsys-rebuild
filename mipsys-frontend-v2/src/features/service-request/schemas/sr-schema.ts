...
export const serviceRequestSchema = z.object({
  ...
  phone_number: z.string().min(1, "Nomor telepon wajib diisi").max(20),
  address_1: z.string().min(1, "Alamat utama wajib diisi").max(255),
  address_3: z.string().min(1, "Kecamatan/Kota wajib diisi").max(255),
  machine_model: z.string().min(1, "Model mesin wajib diisi").max(100),
